...
export const authApi = {
  ...
  signUp: (payload: SignUpPayload) => apiClient.post("/auth/sign_up", payload),
...
export const userApi = {
  getInfo: () => apiClient.get<UserInfo>("/user/info"),

  getHubs: () => apiClient.get<{ hub_ids: string[] }>("/user/hubs"),
};

// ─── Hub ─────────────────────────────────────────────────────────────────────

export const hubApi = {
  create: () => apiClient.post<{ hub_id: string }>("/hub"),
...
export const voiceApi = {
  getMeta: () => apiClient.get<VoiceReference[]>("/user/voice/meta"),
