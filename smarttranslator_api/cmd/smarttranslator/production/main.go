...
// @version         1.0
// @description     Smart Translator API server
...
import (
	...
	"strings"
	"time"
	"smarttranslator/internal"
	"smarttranslator/internal/auth"
	lokisync "smarttranslator/pkg/loki"
	"smarttranslator/pkg/models"

	_ "smarttranslator/docs"
...
func newLogger() (*zap.Logger, zap.AtomicLevel, *os.File, *os.File) {
	...
	lokiSyncer := lokisync.NewBuffered(os.Getenv("LOKI_URL"), "smart-translator", 1000)
	colorCfg := loggerCfg
