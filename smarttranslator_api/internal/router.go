...
func NewRouter(cfg *models.Config, pool *models.Pool, logger *zap.Logger, atom zap.AtomicLevel) {
	...
	corsGroups.GET("/hub/:hub_id/publish", authAPI.IsAuthorized, hubAPI.IsHubIDValid, hubAPI.WsUpgrader, hubAPI.PutCache(hostAndHubs), hubAPI.OpenAISDK, hubAPI.PublishHandler)
